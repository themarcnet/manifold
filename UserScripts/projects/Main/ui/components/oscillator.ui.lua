      ...
      children = {
        ...
        },
        {
          ...
          children = {
            ...
            { id = "sample_pitch_map_toggle", type = "Toggle", x = 64, y = 4, w = 90, h = 20, props = { label = "PMap", value = false }, style = { onColour = 0xfff59e0b, offColour = 0xff334155 } },
            { id = "sample_capture_button", type = "Button", x = 160, y = 4, w = 48, h = 20, props = { label = "Cap" }, style = { bg = 0xff334155, colour = 0xffe2e8f0, fontSize = 10 } },

            { id = "sample_bars_box", type = "Slider", x = 10, y = 34, w = 200, h = 20, props = { min = 0.0625, max = 16.0, step = 0.0625, value = 1.0, label = "Bars", compact = true, showValue = true }, style = { colour = 0xff22d3ee, bg = 0xff08212a, fontSize = 9 } },
            { id = "sample_root_box", type = "Slider", x = 10, y = 60, w = 200, h = 20, props = { min = 12, max = 96, step = 1, value = 60, label = "Root", compact = true, showValue = true }, style = { colour = 0xfffbbf24, bg = 0xff2b2008, fontSize = 9 } },
            { id = "sample_xfade_box", type = "Slider", x = 10, y = 86, w = 200, h = 20, props = { min = 0, max = 50, step = 1, value = 10, label = "X-Fade", compact = true, showValue = true }, style = { colour = 0xfff472b6, bg = 0xff2b1020, fontSize = 9 } },
          },
        },
        {
          id = "blend_tab",
