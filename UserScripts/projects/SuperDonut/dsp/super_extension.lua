-- Project-local SuperDonut DSP extension.
--
-- This is the project-owned Super FX graph that extends the reusable system
-- looper baseline. The intent is explicit: system code provides the looper
-- primitives, while the project defines the SuperDonut routing/FX behavior.
